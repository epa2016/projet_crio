...
function create_field_entry_description($disabled=TRUE)
{
...
function create_field_entry_type($disabled=TRUE)
{
...
function create_field_entry_privacy_status($disabled=TRUE)
{
